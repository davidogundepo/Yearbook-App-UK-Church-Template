...
Color shapeDecorationColor = Color.fromRGBO(36, 120, 129, 1);
Color shapeDecorationColorTwo = Color.fromRGBO(36, 120, 129, 1);
Color shapeDecorationTextColor = Color.fromRGBO(36, 120, 129, 1);
Color shapeDecorationIconColor = Color.fromRGBO(36, 120, 129, 1);
...
Color iconTextColorTwo = Color.fromRGBO(36, 120, 129, 1);
Color buttonColor = Color.fromRGBO(36, 120, 129, 1);
Color textColor = Color.fromRGBO(36, 120, 129, 1);
...
class ChoirDetailsPage extends StatefulWidget {
  ChoirDetailsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ChoirDetailsPage createState() => _ChoirDetailsPage();
}

class _ChoirDetailsPage extends State<ChoirDetailsPage> {
  ...
  Widget build(BuildContext context) {
    choirNotifier = Provider.of<ChoirNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: choirNotifier.currentChoir.image,
                        fit: BoxFit.cover,
                  ...
                  message: choirNotifier.currentChoir.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              choirNotifier.currentChoir.name.toUpperCase(),
  ...
  initState() {
    ...
    _autoBio = choirNotifier.currentChoir.autoBio;
    _bestMoment = choirNotifier.currentChoir.bestMoment;
    _dob = choirNotifier.currentChoir.dob;
    _qualification = choirNotifier.currentChoir.qualification;
    _staffPosition = choirNotifier.currentChoir.staffPosition;
    _yearOfInception = choirNotifier.currentChoir.yearOfInception;
    _regionFrom = choirNotifier.currentChoir.regionOfOrigin;
    _email = choirNotifier.currentChoir.email;
    _facebook = choirNotifier.currentChoir.facebook;
    _hobbies = choirNotifier.currentChoir.hobbies;
    _instagram = choirNotifier.currentChoir.instagram;
    _name = choirNotifier.currentChoir.name;
    _philosophy = choirNotifier.currentChoir.philosophy;
    _phone = choirNotifier.currentChoir.phone;
    _country = choirNotifier.currentChoir.nationality;
    _twitter = choirNotifier.currentChoir.twitter;
    _snapchat = choirNotifier.currentChoir.snapchat;
    _tikTok = choirNotifier.currentChoir.tikTok;
    _worstMoment = choirNotifier.currentChoir.worstMoment;
