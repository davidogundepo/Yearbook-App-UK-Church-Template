...
Color shapeDecorationColor = Color.fromRGBO(233, 213, 218, 1);
Color shapeDecorationColorTwo = Color.fromRGBO(233, 213, 218, 1);
Color shapeDecorationTextColor = Color.fromRGBO(233, 213, 218, 1);
Color shapeDecorationIconColor = Color.fromRGBO(233, 213, 218, 1);
Color cardBackgroundColor =  Colors.black45;
Color splashColor = Color.fromRGBO(233, 213, 218, 1);
Color splashColorTwo =  Colors.black45;
Color splashColorThree = Color.fromRGBO(233, 213, 218, 1);
Color iconTextColor =  Colors.black45;
Color iconTextColorTwo =  Colors.black45;
Color buttonColor = Color.fromRGBO(233, 213, 218, 1);
Color textColor = Color.fromRGBO(233, 213, 218, 1);
...
Color confettiColorSeven =  Colors.black45;
...
MediaUnitNotifier mediaUnitNotifier;
...
class MediaUnitDetailsPage extends StatefulWidget {

  MediaUnitDetailsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _MediaUnitDetailsPage createState() => _MediaUnitDetailsPage();

}

class _MediaUnitDetailsPage extends State<MediaUnitDetailsPage>{
  ...
  Widget build(BuildContext context) {
    ...
    mediaUnitNotifier = Provider.of<MediaUnitNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: mediaUnitNotifier.currentMediaUnit.image,
                        fit: BoxFit.cover,
                  ...
                  message: mediaUnitNotifier.currentMediaUnit.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(mediaUnitNotifier.currentMediaUnit.name.toUpperCase(),
  ...
  initState(){
    ...
    _autoBio = mediaUnitNotifier.currentMediaUnit.autoBio;
      _bestMoment = mediaUnitNotifier.currentMediaUnit.bestMoment;
    _dob = mediaUnitNotifier.currentMediaUnit.dob;
    _qualification = mediaUnitNotifier.currentMediaUnit.qualification;
    _staffPosition = mediaUnitNotifier.currentMediaUnit.staffPosition;
    _yearOfInception = mediaUnitNotifier.currentMediaUnit.yearOfInception;
    _regionFrom = mediaUnitNotifier.currentMediaUnit.regionOfOrigin;
    _email = mediaUnitNotifier.currentMediaUnit.email;
    _facebook = mediaUnitNotifier.currentMediaUnit.facebook;
    _hobbies = mediaUnitNotifier.currentMediaUnit.hobbies;
    _instagram = mediaUnitNotifier.currentMediaUnit.instagram;
    _name = mediaUnitNotifier.currentMediaUnit.name;
    _philosophy = mediaUnitNotifier.currentMediaUnit.philosophy;
    _phone = mediaUnitNotifier.currentMediaUnit.phone;
    _country = mediaUnitNotifier.currentMediaUnit.nationality;
    _twitter = mediaUnitNotifier.currentMediaUnit.twitter;
    _snapchat = mediaUnitNotifier.currentMediaUnit.snapchat;
    _tikTok = mediaUnitNotifier.currentMediaUnit.tikTok;
    _worstMoment = mediaUnitNotifier.currentMediaUnit.worstMoment;
