...
String bestMomentTitle = "My best moment so far in $churchName\n";
String worstMomentTitle = "My worst moment so far in $churchName\n";
...
String yearOfInceptionTitle = "Inception with $churchName\n";
...
Color backgroundColor = Color.fromRGBO(130, 115, 151, 1);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(130, 115, 151, 1);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(130, 115, 151, 1);
Color shapeDecorationColorTwo = Color.fromRGBO(130, 115, 151, 1);
Color shapeDecorationTextColor = Color.fromRGBO(130, 115, 151, 1);
Color shapeDecorationIconColor = Color.fromRGBO(130, 115, 151, 1);
Color cardBackgroundColor = Colors.white;
Color splashColor = Color.fromRGBO(130, 115, 151, 1);
Color splashColorTwo = Colors.white;
Color splashColorThree = Color.fromRGBO(130, 115, 151, 1);
Color iconTextColor = Colors.white;
Color iconTextColorTwo = Colors.white;
Color buttonColor = Color.fromRGBO(130, 115, 151, 1);
Color textColor = Color.fromRGBO(130, 115, 151, 1);
...
SanctuaryKeepersNotifier sanctuaryKeepersNotifier;
...
class SanctuaryKeepersDetailsPage extends StatefulWidget {

  SanctuaryKeepersDetailsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SanctuaryKeepersDetailsPage createState() => _SanctuaryKeepersDetailsPage();

}

class _SanctuaryKeepersDetailsPage extends State<SanctuaryKeepersDetailsPage>{
  ...
  Widget build(BuildContext context) {
    ...
    sanctuaryKeepersNotifier = Provider.of<SanctuaryKeepersNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: sanctuaryKeepersNotifier.currentSanctuaryKeepers.image,
                        fit: BoxFit.cover,
                  ...
                  message: sanctuaryKeepersNotifier.currentSanctuaryKeepers.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(sanctuaryKeepersNotifier.currentSanctuaryKeepers.name.toUpperCase(),
  ...
  initState(){
    ...
    SanctuaryKeepersNotifier sanctuaryKeepersNotifier = Provider.of<SanctuaryKeepersNotifier>(context, listen: false);

    _autoBio = sanctuaryKeepersNotifier.currentSanctuaryKeepers.autoBio;
      _bestMoment = sanctuaryKeepersNotifier.currentSanctuaryKeepers.bestMoment;
    _dob = sanctuaryKeepersNotifier.currentSanctuaryKeepers.dob;
    _qualification = sanctuaryKeepersNotifier.currentSanctuaryKeepers.qualification;
    _staffPosition = sanctuaryKeepersNotifier.currentSanctuaryKeepers.staffPosition;
    _yearOfInception = sanctuaryKeepersNotifier.currentSanctuaryKeepers.yearOfInception;
    _regionFrom = sanctuaryKeepersNotifier.currentSanctuaryKeepers.regionOfOrigin;
    _email = sanctuaryKeepersNotifier.currentSanctuaryKeepers.email;
    _facebook = sanctuaryKeepersNotifier.currentSanctuaryKeepers.facebook;
    _hobbies = sanctuaryKeepersNotifier.currentSanctuaryKeepers.hobbies;
    _instagram = sanctuaryKeepersNotifier.currentSanctuaryKeepers.instagram;
    _name = sanctuaryKeepersNotifier.currentSanctuaryKeepers.name;
    _philosophy = sanctuaryKeepersNotifier.currentSanctuaryKeepers.philosophy;
    _phone = sanctuaryKeepersNotifier.currentSanctuaryKeepers.phone;
    _country = sanctuaryKeepersNotifier.currentSanctuaryKeepers.nationality;
    _twitter = sanctuaryKeepersNotifier.currentSanctuaryKeepers.twitter;
    _snapchat = sanctuaryKeepersNotifier.currentSanctuaryKeepers.snapchat;
    _tikTok = sanctuaryKeepersNotifier.currentSanctuaryKeepers.tikTok;
    _worstMoment = sanctuaryKeepersNotifier.currentSanctuaryKeepers.worstMoment;
