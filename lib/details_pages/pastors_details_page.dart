...
Color backgroundColor = Color.fromRGBO(28, 101, 140, 1.0);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(28, 101, 140, 1.0);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(28, 101, 140, 1.0);
Color shapeDecorationColorTwo = Colors.white;
Color shapeDecorationColorThree = Color.fromRGBO(28, 101, 140, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(28, 101, 140, 1.0);
Color shapeDecorationIconColor = Color.fromRGBO(28, 101, 140, 1.0);
Color cardBackgroundColor = Colors.white;
Color splashColor = Color.fromRGBO(28, 101, 140, 1.0);
Color splashColorTwo = Colors.white;
Color splashColorThree = Color.fromRGBO(28, 101, 140, 1.0);
Color iconTextColor = Colors.white;
Color iconTextColorTwo = Color.fromRGBO(28, 101, 140, 1.0);
Color buttonColor = Color.fromRGBO(28, 101, 140, 1.0);
Color textColor = Color.fromRGBO(28, 101, 140, 1.0);
...
PastorsNotifier pastorsNotifier;
...
class _SubPageState extends State<SubPage> {
  ...
  Widget build(BuildContext context) {
    pastorsNotifier = Provider.of<PastorsNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: pastorsNotifier.currentPastors.image,
                        fit: BoxFit.cover,
                  ...
                  message: pastorsNotifier.currentPastors.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              pastorsNotifier.currentPastors.name.toUpperCase(),
  ...
  initState() {
    ...
    PastorsNotifier pastorsNotifier = Provider.of<PastorsNotifier>(context, listen: false);

    _autoBio = pastorsNotifier.currentPastors.autoBio;
    _bestMoment = pastorsNotifier.currentPastors.bestMoment;
    _dob = pastorsNotifier.currentPastors.dob;
    _qualification = pastorsNotifier.currentPastors.qualification;
    _staffPosition = pastorsNotifier.currentPastors.staffPosition;
    _yearOfInception = pastorsNotifier.currentPastors.yearOfInception;
    _regionFrom = pastorsNotifier.currentPastors.regionOfOrigin;
    _email = pastorsNotifier.currentPastors.email;
    _facebook = pastorsNotifier.currentPastors.facebook;
    _hobbies = pastorsNotifier.currentPastors.hobbies;
    _instagram = pastorsNotifier.currentPastors.instagram;
    _name = pastorsNotifier.currentPastors.name;
    _philosophy = pastorsNotifier.currentPastors.philosophy;
    _phone = pastorsNotifier.currentPastors.phone;
    _country = pastorsNotifier.currentPastors.nationality;
    _twitter = pastorsNotifier.currentPastors.twitter;
    _snapchat = pastorsNotifier.currentPastors.snapchat;
    _tikTok = pastorsNotifier.currentPastors.tikTok;
    _worstMoment = pastorsNotifier.currentPastors.worstMoment;
