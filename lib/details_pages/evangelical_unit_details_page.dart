...
Color backgroundColor = Color.fromRGBO(0, 147, 171, 1.0);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(0, 147, 171, 1.0);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(0, 147, 171, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(0, 147, 171, 1.0);
Color shapeDecorationColorTwo = Color.fromRGBO(0, 147, 171, 1.0);
Color cardBackgroundColor = Colors.white;
Color splashColor = Colors.white;
Color splashColorTwo = Color.fromRGBO(0, 147, 171, 1.0);
Color splashColorThree = Color.fromRGBO(0, 147, 171, 1.0);
Color iconTextColor = Colors.white;
Color iconTextColorTwo = Color.fromRGBO(0, 147, 171, 1.0);
Color buttonColor = Color.fromRGBO(0, 147, 171, 1.0);
Color textColor = Color.fromRGBO(0, 147, 171, 1.0);
...
EvangelicalUnitNotifier evangelicalUnitNotifier;
...
class EvangelicalUnitDetailsPage extends StatefulWidget {
  EvangelicalUnitDetailsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _EvangelicalUnitDetailsPage createState() => _EvangelicalUnitDetailsPage();
}

class _EvangelicalUnitDetailsPage extends State<EvangelicalUnitDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    evangelicalUnitNotifier = Provider.of<EvangelicalUnitNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: evangelicalUnitNotifier.currentEvangelicalUnit.image,
                        fit: BoxFit.cover,
                  ...
                  message: evangelicalUnitNotifier.currentEvangelicalUnit.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              evangelicalUnitNotifier.currentEvangelicalUnit.name.toUpperCase(),
  ...
  initState() {
    ...
    EvangelicalUnitNotifier evangelicalUnitNotifier = Provider.of<EvangelicalUnitNotifier>(context, listen: false);

    _autoBio = evangelicalUnitNotifier.currentEvangelicalUnit.autoBio;
    _bestMoment = evangelicalUnitNotifier.currentEvangelicalUnit.bestMoment;
    _dob = evangelicalUnitNotifier.currentEvangelicalUnit.dob;
    _qualification = evangelicalUnitNotifier.currentEvangelicalUnit.qualification;
    _staffPosition = evangelicalUnitNotifier.currentEvangelicalUnit.staffPosition;
    _yearOfInception = evangelicalUnitNotifier.currentEvangelicalUnit.yearOfInception;
    _regionFrom = evangelicalUnitNotifier.currentEvangelicalUnit.regionOfOrigin;
    _email = evangelicalUnitNotifier.currentEvangelicalUnit.email;
    _facebook = evangelicalUnitNotifier.currentEvangelicalUnit.facebook;
    _hobbies = evangelicalUnitNotifier.currentEvangelicalUnit.hobbies;
    _instagram = evangelicalUnitNotifier.currentEvangelicalUnit.instagram;
    _name = evangelicalUnitNotifier.currentEvangelicalUnit.name;
    _philosophy = evangelicalUnitNotifier.currentEvangelicalUnit.philosophy;
    _phone = evangelicalUnitNotifier.currentEvangelicalUnit.phone;
    _country = evangelicalUnitNotifier.currentEvangelicalUnit.nationality;
    _twitter = evangelicalUnitNotifier.currentEvangelicalUnit.twitter;
    _snapchat = evangelicalUnitNotifier.currentEvangelicalUnit.snapchat;
    _tikTok = evangelicalUnitNotifier.currentEvangelicalUnit.tikTok;
    _worstMoment = evangelicalUnitNotifier.currentEvangelicalUnit.worstMoment;
