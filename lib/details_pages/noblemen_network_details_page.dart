...
Color shapeDecorationColor = Color.fromRGBO(86, 187, 241, 1);
Color shapeDecorationColorTwo = Color.fromRGBO(86, 187, 241, 1);
Color shapeDecorationTextColor = Color.fromRGBO(86, 187, 241, 1);
Color shapeDecorationIconColor = Color.fromRGBO(86, 187, 241, 1);
Color cardBackgroundColor = Colors.white;
Color splashColor = Color.fromRGBO(86, 187, 241, 1);
Color splashColorTwo = Colors.white;
Color splashColorThree = Color.fromRGBO(86, 187, 241, 1);
Color iconTextColor = Colors.white;
Color iconTextColorTwo = Colors.white;
Color buttonColor = Color.fromRGBO(86, 187, 241, 1);
Color textColor = Color.fromRGBO(86, 187, 241, 1);
...
NoblemenNetworkNotifier noblemenNetworkNotifier;
...
class NoblemenNetworkDetailsPage extends StatefulWidget {

  NoblemenNetworkDetailsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _NoblemenNetworkDetailsPage createState() => _NoblemenNetworkDetailsPage();

}

class _NoblemenNetworkDetailsPage extends State<NoblemenNetworkDetailsPage>{
  ...
  Widget build(BuildContext context) {
    ...
    noblemenNetworkNotifier = Provider.of<NoblemenNetworkNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: noblemenNetworkNotifier.currentNoblemenNetwork.image,
                        fit: BoxFit.cover,
                  ...
                  message: noblemenNetworkNotifier.currentNoblemenNetwork.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(noblemenNetworkNotifier.currentNoblemenNetwork.name.toUpperCase(),
  ...
  initState(){
    ...
    _autoBio = noblemenNetworkNotifier.currentNoblemenNetwork.autoBio;
      _bestMoment = noblemenNetworkNotifier.currentNoblemenNetwork.bestMoment;
    _dob = noblemenNetworkNotifier.currentNoblemenNetwork.dob;
    _qualification = noblemenNetworkNotifier.currentNoblemenNetwork.qualification;
    _staffPosition = noblemenNetworkNotifier.currentNoblemenNetwork.staffPosition;
    _yearOfInception = noblemenNetworkNotifier.currentNoblemenNetwork.yearOfInception;
    _regionFrom = noblemenNetworkNotifier.currentNoblemenNetwork.regionOfOrigin;
    _email = noblemenNetworkNotifier.currentNoblemenNetwork.email;
    _facebook = noblemenNetworkNotifier.currentNoblemenNetwork.facebook;
    _hobbies = noblemenNetworkNotifier.currentNoblemenNetwork.hobbies;
    _instagram = noblemenNetworkNotifier.currentNoblemenNetwork.instagram;
    _name = noblemenNetworkNotifier.currentNoblemenNetwork.name;
    _philosophy = noblemenNetworkNotifier.currentNoblemenNetwork.philosophy;
    _phone = noblemenNetworkNotifier.currentNoblemenNetwork.phone;
    _country = noblemenNetworkNotifier.currentNoblemenNetwork.nationality;
    _twitter = noblemenNetworkNotifier.currentNoblemenNetwork.twitter;
    _snapchat = noblemenNetworkNotifier.currentNoblemenNetwork.snapchat;
    _tikTok = noblemenNetworkNotifier.currentNoblemenNetwork.tikTok;
    _worstMoment = noblemenNetworkNotifier.currentNoblemenNetwork.worstMoment;
