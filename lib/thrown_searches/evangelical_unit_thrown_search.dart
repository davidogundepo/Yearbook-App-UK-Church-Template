...
class MyEvangelicalUnitSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyEvangelicalUnitSearch({@required this.all});
  ...
  Future navigateToEvangelicalUnitDetailsPage(context) async {
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((evangelicalUnit) => evangelicalUnit.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((evangelicalUnit) => evangelicalUnit.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          evangelicalUnitNotifier.currentEvangelicalUnit = search[position];
                          navigateToEvangelicalUnitDetailsPage(context);
                        },
