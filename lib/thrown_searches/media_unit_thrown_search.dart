...
Color textHighlightColor = Colors.black45;

var queryTech;

class MyMediaUnitSearch extends SearchDelegate {

  final List all;

  MyMediaUnitSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((mediaUnit) => mediaUnit.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((mediaUnit) => mediaUnit.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          mediaUnitNotifier.currentMediaUnit = search[position];
