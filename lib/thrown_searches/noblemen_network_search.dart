...
Color modalBackgroundColor =Color.fromRGBO(86, 187, 241, 1);
...
Color dialogBackgroundColor = Color.fromRGBO(86, 187, 241, 1);
Color borderColor = Colors.black;
Color textHighlightColor = Color.fromRGBO(26, 88, 121, 1.0);

var queryTech;

class MyNoblemenNetworkSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyNoblemenNetworkSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((noblemenNetwork) => noblemenNetwork.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((noblemenNetwork) => noblemenNetwork.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          noblemenNetworkNotifier.currentNoblemenNetwork = search[position];
