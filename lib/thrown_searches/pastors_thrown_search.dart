...
class MyPastorsSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyPastorsSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((pastors) => pastors.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((pastors) => pastors.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          pastorsNotifier.currentPastors = search[position];
