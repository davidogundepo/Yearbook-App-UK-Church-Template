...
String pastorsTitle = "Pastors";
String choirTitle = "Choir";
String mediaUnitTitle = "Media Unit Members";
String sanctuaryKeepersTitle = "Sanctuary Keepers";
String evangelicalUnitTitle = "Evangelical Unit Members";
String noblemenNetworkTitle = "Noblemen Members";
...
String imgAsset = "assets/images/c_landing_4.jpg";

Color gradientColor = Color.fromRGBO(89, 82, 96, 1.0);
Color gradientColorTwo = Colors.white;
Color linearGradientColor =  Color.fromRGBO(89, 82, 96, 1.0);
Color linearGradientColorTwo =  Color.fromRGBO(89, 82, 96, 1.0);
Color boxShadowColor =  Color.fromRGBO(89, 82, 96, 1.0);
Color dividerColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shimmerBaseColor = Colors.white;
Color shimmerHighlightColor = Colors.white;
Color shapeDecorationTextColor =  Color.fromRGBO(89, 82, 96, 1.0);
Color containerBackgroundColor =  Color.fromRGBO(89, 82, 96, 1.0);
Color containerIconColor = Colors.white;
Color dialogBackgroundColor =  Color.fromRGBO(89, 82, 96, 1.0);
Color dialogTextColor = Colors.white;
Color splashColor = Color.fromRGBO(89, 82, 96, 1.0);
Color splashColorTwo = Colors.white;
Color splashColorThree = Colors.white;
Color textColor = Colors.white;
Color textColorTwo = Color.fromRGBO(89, 82, 96, 1.0);
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(0);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.myPastorsPageClickedEvent);
                                },
                                child: Align(
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(1);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.myChoirPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItems(
                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(2);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.myMediaUnitPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItems(
                                    icon: MdiIcons.microphone,
                                    title: mediaUnitTitle,
                                  ),
                                ),
                              ),
                            ),
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(3);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.mySanctuaryKeepersPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItems(
                                    icon: MdiIcons.pillar,
                                    title: sanctuaryKeepersTitle,
                                  ),
                                ),
                              ),
                            ),
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(4);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.myEvangelicalUnitPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItems(
                                    icon: MdiIcons.walk,
                                    title: evangelicalUnitTitle,
                                  ),
                                ),
                              ),
                            ),
                            Material(
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  _onSelected(5);
                                  onIconPressed();
                                  BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.myNoblemenNetworkPageClickedEvent);
                                },
                                child: Align(
                                  alignment: Alignment.centerLeft,
                                  child: MenuItems(
                                    icon: MdiIcons.pacMan,
                                    title: noblemenNetworkTitle,
                                  ),
                                ),
                              ),
                            ),
